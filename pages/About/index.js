...
const About = () => {
  return(
    <div className=''>
      ...
      <TextWithImage title='Other interests...' copy="My love for coding has brought me this far, but I am more than just a developer. My other interests include photography, skateboarding, music production, sports (mainly basketball), and more. My life is filled with artistic and physical outlets as means of maintaining a healthy work-life balance and I wouldn't be me without the things I love." image='https://live.staticflickr.com/65535/52622696094_9257d16cbf_b.jpg' position='end'/>
